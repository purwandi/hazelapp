...
const Item = props => (
  <div class="border-bottom pl-4 pr-5 pb-3 pt-3 d-flex flex-column flex-md-row flex-md-items-center">
...
const Layout = () => {
  ...
  return (
    <React.Fragment>
      ...
      <Item
        title="Projects"
        description="Implement project management for linear issues"
      />
