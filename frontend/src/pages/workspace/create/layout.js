...
const Layout = ({ onCreateProject, setState }) => (
  <div className="h-screen flex flex-col">
    <div className="flex-1 overflow-y-auto">
      <form className="w-3/5 mx-auto py-12" onSubmit={onCreateProject}>
        ...
        <div className="mt-6">
          <button
            type="submit"
            className="bg-indigo-500 text-white font-semibold rounded px-5 py-2"
          >
            Create project
          </button>
...
Layout.propTypes = {
  onCreateProject: func.isRequired,
